...
/* ... */
  ...
  .photo-ring { width: 80px; height: 80px; border-radius: 50%; border: 3px solid #fdc003; overflow: hidden; flex-shrink: 0; }
  ...
  .job-year { background: #fdc003; color: #003f74; font-size: 11px; font-weight: 500; padding: 2px 8px; border-radius: 20px; white-space: nowrap; }
    ...
    <section class="relative py-20 overflow-hidden border-b border-outline-variant/10">
        ...
        <div class="max-w-4xl mx-auto px-6 relative z-10 text-center">
            <nav class="flex justify-center mb-4 text-xs font-medium text-white/60 uppercase tracking-widest gap-2">
                ...
                <span>/</span>
                <span class="text-white">Sekretariat Daerah</span>
            </nav>
...
<h2 class="sr-only">Profil pejabat Muhaimin, S.T., MT — riwayat pendidikan dan jabatan</h2>

<div class="ppid-card">

  <div class="ppid-header">
    <div class="photo-ring">
        <img src="{{ asset('images/foto pejabat/MUHAIMIN.jpg') }}" alt="Foto Muhaimin, S.T., M.T." class="ppid-photo">
    </div>
    <div style="flex:1;">
      <div class="ppid-badge">Pejabat Badan Publik</div>
      <p class="ppid-name">MUHAIMIN, S.T., M.T.</p>
      <p class="ppid-title">Sekretaris Daerah &mdash; Pemerintah Kota Balikpapan</p>
    </div>
  </div>
  ...
  <table class="job-table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>Kepala Dinas Pendidikan<br><span style="font-size:12px;color:var(--color-text-secondary);">Dinas Pendidikan</span></td>
      ...
      <tr>
        ...
        <td>Kepala Dinas Tata Kota dan Perumahan<br><span style="font-size:12px;color:var(--color-text-secondary);">Dinas Tata Kota dan Perumahan</span></td>
        <td style="text-align:right;padding-right:1.5rem;"><span class="job-year">2011</span></td>
      </tr>
    </tbody>
  </table>
