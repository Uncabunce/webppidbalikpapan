...
/* ... */
        ...
        .avatar-image { 
            width: 100%; 
            height: 100%; 
            object-fit: cover;        /* foto mengisi penuh lingkaran */
            object-position: top center;  /* prioritas bagian atas (wajah) */
            display: block; 
        }
        /* Mega Menu */
        .mega-menu {
...
<main class="bg-surface min-h-screen">
    <section class="relative py-20 overflow-hidden border-b border-outline-variant/10">
        ...
        <div class="max-w-4xl mx-auto px-6 relative z-10 text-center">
            <nav class="flex justify-center mb-4 text-xs font-medium text-white/60 uppercase tracking-widest gap-2">
                ...
                <span>/</span>
                <span class="text-white">Asisten-Tata-Pemerintahan</span>
            </nav>
    ...
    <div class="max-w-7xl mx-auto px-4 md:px-6 py-10">
        <h2 class="sr-only">Profil pejabat Drs. Zulkipli, M.Si — Asisten Administrasi Daerah — riwayat pendidikan dan jabatan</h2>
...
<div class="ppid-card">
  ...
  <div class="ppid-header">
    ...
    <div style="flex:1;">
      ...
      <p class="ppid-title">Asisten Administrasi Daerah &mdash; Pemerintah Kota Balikpapan</p>    </div>
  </div>
  ...
  <table class="edu-table">
    ...
    <tbody>
      <tr>
        ...
        <td style="color:var(--color-text-secondary);">Ilmu Sosial dan Politik — Ilmu Administrasi Negara</td>
      </tr>
      <tr>
  ...
  <table class="job-table">
    ...
    <tbody>
      <tr>
        ...
        <td>Asisten Tata Pemerintahan<br><span style="font-size:12px;color:var(--color-text-secondary);">Sekretariat Daerah</span></td>
