    ...
    <section class="relative py-20 overflow-hidden border-b border-outline-variant/10">
        ...
        <div class="max-w-4xl mx-auto px-6 relative z-10 text-center">
            <nav class="flex justify-center mb-4 text-xs font-medium text-white/60 uppercase tracking-widest gap-2">
                ...
                <span>/</span>
                <span class="text-white">SK Klasifikasi Informasi yang Dikecualikan</span>
            </nav>
            <h1 class="text-4xl md:text-5xl font-headline font-extrabold text-white leading-tight mb-4">
                SK Klasifikasi Informasi<br>yang Dikecualikan
            </h1>
            <p class="text-white/70 text-lg max-w-2xl mx-auto">
                Pemerintah Kota Balikpapan &mdash; Surat Keputusan Penetapan Klasifikasi Informasi Dikecualikan
            </p>
        </div>
    </section>
    ...
    <div class="max-w-5xl mx-auto px-4 md:px-6 py-12 space-y-10">
        ...
        <div class="bg-white rounded-2xl border border-outline-variant/30 shadow-sm overflow-hidden">
            <div class="bg-primary px-6 py-4 flex items-center gap-3">
                <span class="material-symbols-outlined text-secondary-container">policy</span>
                <div>
                    <p class="text-white font-headline font-extrabold text-sm leading-tight">SK Klasifikasi Informasi yang Dikecualikan &mdash; Pemerintah Kota Balikpapan</p>
        ...
        <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div class="bg-white rounded-2xl border border-outline-variant/30 shadow-sm p-6">
                    ...
                    <p class="text-xs text-outline mt-1 leading-snug">Dokumen SK Klasifikasi tersedia</p>
                ...
                <div class="bg-primary rounded-2xl shadow-sm p-6">
                    <div class="flex items-start justify-between mb-3">
                        <span class="material-symbols-outlined text-2xl text-secondary-container">shield_lock</span>
                    ...
                    <p class="text-2xl font-headline font-extrabold text-white leading-tight">Dikecualikan</p>
                    <p class="text-xs text-white/70 mt-1 leading-snug">SK penetapan klasifikasi informasi yang dikecualikan dari keterbukaan publik</p>
        ...
        <!-- Dokumen Card -->
        <div>
            <h2 class="text-lg font-headline font-extrabold text-primary mb-5">Dokumen SK Klasifikasi</h2>
            <div class="bg-white rounded-2xl border border-outline-variant/30 shadow-sm overflow-hidden">
                <div class="flex items-center justify-between px-6 py-4 border-b border-outline-variant/20">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="font-headline font-extrabold text-on-surface text-sm">SK Klasifikasi Informasi yang Dikecualikan &mdash; Pemerintah Kota Balikpapan</p>
                ...
                <div class="px-6 py-4 flex flex-wrap gap-3">
                    <a href="{{ asset('sk_klasifikasi.pdf') }}" target="_blank"
                    ...
                    <a href="{{ asset('sk_klasifikasi.pdf') }}" download
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <a href="/informasi/SK_maklumat"
                   class="flex items-center gap-3 bg-white border border-outline-variant/30 rounded-xl px-5 py-4 hover:border-primary hover:shadow-sm transition-all group">
                    <span class="material-symbols-outlined text-outline group-hover:text-primary transition-colors">article</span>
                    <div>
                        ...
                        <p class="text-xs text-outline">Surat Keputusan Maklumat</p>
                    </div>
        ...
        <div class="bg-surface-container-low rounded-2xl border border-outline-variant/20 px-6 py-5 flex gap-4 items-start">
            ...
            <div>
                ...
                <p class="text-xs text-outline leading-relaxed">Surat Keputusan Klasifikasi Informasi yang Dikecualikan merupakan dokumen resmi Pemerintah Kota Balikpapan yang menetapkan kategori informasi yang dikecualikan dari keterbukaan publik sesuai dengan ketentuan Undang-Undang No. 14 Tahun 2008 tentang Keterbukaan Informasi Publik. Penetapan ini dilakukan untuk melindungi kepentingan yang sah sesuai dengan ketentuan peraturan perundang-undangan yang berlaku.</p>
            </div>
        </div>
