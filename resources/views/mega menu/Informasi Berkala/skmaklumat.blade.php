    ...
    <section class="relative py-20 overflow-hidden border-b border-outline-variant/10">
        ...
        <div class="max-w-4xl mx-auto px-6 relative z-10 text-center">
            <nav class="flex justify-center mb-4 text-xs font-medium text-white/60 uppercase tracking-widest gap-2">
                ...
                <span>/</span>
                <span class="text-white">SK Maklumat Pelayanan DISKOMINFO</span>
            </nav>
            <h1 class="text-4xl md:text-5xl font-headline font-extrabold text-white leading-tight mb-4">
                SK Maklumat Pelayanan DISKOMINFO
            </h1>
            <p class="text-white/70 text-lg max-w-2xl mx-auto">
                Pemerintah Kota Balikpapan &mdash; Surat Keputusan Maklumat Pelayanan Informasi Publik di Dinas Komunikasi dan Informatika Kota Balikpapan
            </p>
        </div>
    </section>
    ...
    <div class="max-w-5xl mx-auto px-4 md:px-6 py-12 space-y-10">
        ...
        <div class="bg-white rounded-2xl border border-outline-variant/30 shadow-sm overflow-hidden">
            <div class="bg-primary px-6 py-4 flex items-center gap-3">
                ...
                <div>
                    <p class="text-white font-headline font-extrabold text-sm leading-tight">SK Maklumat Pelayanan DISKOMINFO &mdash; Pemerintah Kota Balikpapan</p>
        ...
        <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div class="bg-white rounded-2xl border border-outline-variant/30 shadow-sm p-6">
                    ...
                    <p class="text-xs text-outline mt-1 leading-snug">Dokumen SK Maklumat tersedia</p>
                ...
                <div class="bg-primary rounded-2xl shadow-sm p-6">
                    <div class="flex items-start justify-between mb-3">
                        <span class="material-symbols-outlined text-2xl text-secondary-container">campaign</span>
                    ...
                    <p class="text-2xl font-headline font-extrabold text-white leading-tight">Maklumat</p>
                    <p class="text-xs text-white/70 mt-1 leading-snug">SK maklumat pelayanan informasi publik Dinas Komunikasi dan Informatika Kota Balikpapan</p>
        ...
        <!-- Dokumen Card -->
        <div>
            <h2 class="text-lg font-headline font-extrabold text-primary mb-5">Dokumen SK Maklumat</h2>
            <div class="bg-white rounded-2xl border border-outline-variant/30 shadow-sm overflow-hidden">
                <div class="flex items-center justify-between px-6 py-4 border-b border-outline-variant/20">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="font-headline font-extrabold text-on-surface text-sm">SK Maklumat Pelayanan DISKOMINFO &mdash; Pemerintah Kota Balikpapan</p>
                ...
                <div class="px-6 py-4 flex flex-wrap gap-3">
                    <a href="{{ asset('sk_maklumat.pdf') }}" target="_blank"
                    ...
                    <a href="{{ asset('sk_maklumat.pdf') }}" download
        ...
        <div class="bg-surface-container-low rounded-2xl border border-outline-variant/20 px-6 py-5 flex gap-4 items-start">
            ...
            <div>
                ...
                <p class="text-xs text-outline leading-relaxed">Surat Keputusan Maklumat Pelayanan Informasi Publik merupakan dokumen resmi yang ditetapkan oleh Dinas Komunikasi dan Informatika (DISKOMINFO) Kota Balikpapan sebagai pernyataan komitmen pelayanan informasi publik kepada masyarakat. Dokumen ini disusun sebagai bentuk akuntabilitas dan transparansi penyelenggaraan pelayanan informasi sesuai dengan ketentuan Undang-Undang No. 14 Tahun 2008 tentang Keterbukaan Informasi Publik.</p>
            </div>
        </div>
