...
<li><a href="/informasi/realisasi-2024" class="text-[11px] text-slate-600 hover:text-primary block py-0.5 leading-snug">Realisasi Kegiatan dan Kinerja Pemkot Balikpapan Tahun 2023</a></li>
...
<a href="/informasi/realisasi-2024" class="block px-5 py-2 text-xs text-slate-300 hover:text-secondary-container border-b border-white/5">Realisasi Kegiatan dan Kinerja Pemkot Balikpapan Tahun 2022</a>
    ...
    <section class="relative py-20 overflow-hidden border-b border-outline-variant/10">
        ...
        <div class="max-w-4xl mx-auto px-6 relative z-10 text-center">
            <nav class="flex justify-center mb-4 text-xs font-medium text-white/60 uppercase tracking-widest gap-2">
                ...
                <span>/</span>
                <span class="text-white">SK Penetapan Daftar Informasi Publik</span>
            </nav>
            <h1 class="text-4xl md:text-5xl font-headline font-extrabold text-white leading-tight mb-4">
                SK Penetapan Daftar<br>Informasi Publik
            </h1>
            <p class="text-white/70 text-lg max-w-2xl mx-auto">
                Pemerintah Kota Balikpapan &mdash; Surat Keputusan Penetapan Daftar Informasi Publik Pemkot Balikpapan
            </p>
        </div>
    </section>
    ...
    <div class="max-w-5xl mx-auto px-4 md:px-6 py-12 space-y-10">
        ...
        <div class="bg-white rounded-2xl border border-outline-variant/30 shadow-sm overflow-hidden">
            <div class="bg-primary px-6 py-4 flex items-center gap-3">
                ...
                <div>
                    <p class="text-white font-headline font-extrabold text-sm leading-tight">SK Penetapan Daftar Informasi Publik &mdash; Pemerintah Kota Balikpapan</p>
            ...
            <div class="px-6 py-4 flex flex-wrap gap-6 text-sm text-on-surface">
                ...
                <div class="flex items-center gap-2">
                    <span class="material-symbols-outlined text-base text-outline">gavel</span>
                    <span>Dasar Hukum: UU No. 14 Tahun 2008</span>
                </div>
                <div class="flex items-center gap-2">
        ...
        <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div class="bg-white rounded-2xl border border-outline-variant/30 shadow-sm p-6">
                    ...
                    <p class="text-xs text-outline mt-1 leading-snug">Dokumen SK tersedia</p>
                    <div class="mt-4 pt-4 border-t border-outline-variant/30 text-xs text-on-surface">
                        <span class="font-bold text-primary">SK Penetapan Resmi</span>
                    </div>
                </div>
                ...
                <div class="bg-primary rounded-2xl shadow-sm p-6">
                    <div class="flex items-start justify-between mb-3">
                        <span class="material-symbols-outlined text-2xl text-secondary-container">list_alt</span>
                        <span class="text-[10px] font-extrabold uppercase tracking-widest text-white/70 bg-white/10 px-2 py-1 rounded-full">Status</span>
                    </div>
                    <p class="text-2xl font-headline font-extrabold text-white leading-tight">Ditetapkan</p>
                    <p class="text-xs text-white/70 mt-1 leading-snug">SK penetapan daftar informasi publik yang wajib disediakan dan diumumkan</p>
        ...
        <!-- Dokumen Card -->
        <div>
            <h2 class="text-lg font-headline font-extrabold text-primary mb-5">Dokumen SK Penetapan</h2>
            <div class="bg-white rounded-2xl border border-outline-variant/30 shadow-sm overflow-hidden">
                <div class="flex items-center justify-between px-6 py-4 border-b border-outline-variant/20">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="font-headline font-extrabold text-on-surface text-sm">SK Penetapan Daftar Informasi Publik Pemkot Balikpapan</p>
                            <p class="text-xs text-outline mt-0.5">Format: PDF &nbsp;&middot;&nbsp; Pemerintah Kota Balikpapan</p>
                        </div>
                    </div>
                    <span class="text-[10px] font-extrabold uppercase tracking-widest text-primary bg-primary/10 px-3 py-1 rounded-full hidden sm:inline-block">Resmi</span>
                </div>
                <div class="px-6 py-4 flex flex-wrap gap-3">
                    <a href="{{ asset('sk_info_publik.pdf') }}" target="_blank"
                    ...
                    <a href="{{ asset('sk_info_publik.pdf') }}" download
        ...
        <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <a href="/informasi/SK_klasifikasi"
                   class="flex items-center gap-3 bg-white border border-outline-variant/30 rounded-xl px-5 py-4 hover:border-primary hover:shadow-sm transition-all group">
                    <span class="material-symbols-outlined text-outline group-hover:text-primary transition-colors">policy</span>
                    <div>
                        <p class="text-sm font-semibold text-on-surface group-hover:text-primary transition-colors">SK Klasifikasi Informasi Dikecualikan</p>
                        <p class="text-xs text-outline">Penetapan informasi yang dikecualikan</p>
                    </div>
                    <span class="material-symbols-outlined text-outline ml-auto text-sm">chevron_right</span>
                </a>
                <a href="/informasi/SK_maklumat"
                   class="flex items-center gap-3 bg-white border border-outline-variant/30 rounded-xl px-5 py-4 hover:border-primary hover:shadow-sm transition-all group">
                    <span class="material-symbols-outlined text-outline group-hover:text-primary transition-colors">campaign</span>
                    <div>
                        <p class="text-sm font-semibold text-on-surface group-hover:text-primary transition-colors">SK Maklumat Pelayanan DISKOMINFO</p>
                        <p class="text-xs text-outline">Surat Keputusan Maklumat Pelayanan</p>
                    </div>
                    <span class="material-symbols-outlined text-outline ml-auto text-sm">chevron_right</span>
                </a>
                <a href="/informasi/SK_pengawasan"
                   class="flex items-center gap-3 bg-white border border-outline-variant/30 rounded-xl px-5 py-4 hover:border-primary hover:shadow-sm transition-all group">
                    <span class="material-symbols-outlined text-outline group-hover:text-primary transition-colors">manage_search</span>
                    <div>
                        <p class="text-sm font-semibold text-on-surface group-hover:text-primary transition-colors">SK Penetapan Strategi Pembinaan &amp; Pengawasan</p>
                        <p class="text-xs text-outline">Strategi dan Metode Monitoring</p>
                    </div>
                    <span class="material-symbols-outlined text-outline ml-auto text-sm">chevron_right</span>
                </a>
                <a href="/informasi/daftarinformasi"
                   class="flex items-center gap-3 bg-white border border-outline-variant/30 rounded-xl px-5 py-4 hover:border-primary hover:shadow-sm transition-all group">
                    <span class="material-symbols-outlined text-outline group-hover:text-primary transition-colors">format_list_bulleted</span>
                    <div>
                        <p class="text-sm font-semibold text-on-surface group-hover:text-primary transition-colors">Daftar Informasi Publik</p>
                        <p class="text-xs text-outline">Informasi Setiap Saat</p>
                    </div>
                    <span class="material-symbols-outlined text-outline ml-auto text-sm">chevron_right</span>
                </a>
            </div>
        ...
        <div class="bg-surface-container-low rounded-2xl border border-outline-variant/20 px-6 py-5 flex gap-4 items-start">
            ...
            <div>
                ...
                <p class="text-xs text-outline leading-relaxed">Surat Keputusan Penetapan Daftar Informasi Publik merupakan dokumen resmi Pemerintah Kota Balikpapan yang menetapkan daftar informasi publik yang wajib disediakan, diumumkan, dan dapat diakses oleh masyarakat. Penetapan ini merupakan kewajiban badan publik sesuai Undang-Undang No. 14 Tahun 2008 tentang Keterbukaan Informasi Publik sebagai wujud transparansi dan akuntabilitas penyelenggaraan pemerintahan daerah.</p>
            </div>
        </div>
