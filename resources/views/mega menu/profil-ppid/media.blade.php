...
<main class="bg-surface min-h-screen">
    <section class="relative py-20 overflow-hidden border-b border-outline-variant/10">
        ...
        <div class="max-w-4xl mx-auto px-6 relative z-10 text-center">
            <nav class="flex justify-center mb-4 text-xs font-medium text-white/60 uppercase tracking-widest gap-2">
                ...
                <span>Profil</span>
                <span>/</span>
                <span class="text-white">Media Layanan</span>
            </nav>
    ...
    <p class="text-center text-sm text-outline mb-10">
        Pemohon dapat menggunakan layanan informasi publik melalui media berikut:
    </p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        {{-- Formulir Online --}}
        <div class="rounded-2xl border border-primary-container bg-surface-container-lowest shadow-sm overflow-hidden flex flex-col">
            <div class="bg-primary px-5 py-4 flex items-center gap-3">
                <span class="material-symbols-outlined text-secondary-container text-2xl">edit_note</span>
                <h2 class="font-headline font-extrabold text-white text-sm tracking-wide">Formulir Online</h2>
            </div>
            <div class="px-5 py-5 flex-1 flex flex-col justify-between gap-4">
                <p class="text-xs text-on-surface leading-relaxed">
                    Ajukan permohonan informasi publik secara online melalui formulir digital yang tersedia.
                </p>
                <a href="https://id.pinterest.com/pin/1134555331122734760/"
                   class="inline-flex items-center gap-2 self-start bg-secondary-container text-on-secondary-container text-xs font-extrabold px-4 py-2 rounded-full hover:opacity-90 transition-opacity">
        ...
        {{-- Email --}}
        <div class="rounded-2xl border border-tertiary-container bg-surface-container-lowest shadow-sm overflow-hidden flex flex-col">
            <div class="bg-tertiary-container px-5 py-4 flex items-center gap-3">
                <span class="material-symbols-outlined text-on-tertiary-container text-2xl">mail</span>
                <h2 class="font-headline font-extrabold text-on-tertiary-container text-sm tracking-wide">Pos Elektronik</h2>
            </div>
            <div class="px-5 py-5 flex-1 flex flex-col justify-between gap-4">
                <p class="text-xs text-on-surface leading-relaxed">
                    Kirimkan permohonan informasi melalui email resmi PPID Kota Balikpapan.
                </p>
                <div class="space-y-2">
                    <a href="mailto:ppid@balikpapan.go.id"
                       class="flex items-center gap-2 text-xs text-tertiary font-semibold hover:underline underline-offset-2 break-all">
                        <span class="material-symbols-outlined text-base shrink-0">alternate_email</span>
                        ppid@balikpapan.go.id
                    </a>
                    <a href="mailto:diskominfobalikpapan@gmail.com"
                       class="flex items-center gap-2 text-xs text-tertiary font-semibold hover:underline underline-offset-2 break-all">
                        <span class="material-symbols-outlined text-base shrink-0">alternate_email</span>
                        diskominfobalikpapan@gmail.com
                    </a>
                </div>
            </div>
        </div>
        ...
        {{-- Datang Langsung --}}
        <div class="rounded-2xl border border-secondary-container bg-surface-container-lowest shadow-sm overflow-hidden flex flex-col">
            <div class="bg-secondary-container px-5 py-4 flex items-center gap-3">
                <span class="material-symbols-outlined text-on-secondary-container text-2xl">location_on</span>
                <h2 class="font-headline font-extrabold text-on-secondary-container text-sm tracking-wide">Datang Langsung</h2>
            </div>
            <div class="px-5 py-5 flex-1 flex flex-col justify-between gap-4">
                <div class="space-y-2 text-xs text-on-surface leading-relaxed">
                    <p class="font-semibold text-primary">Dinas Komunikasi dan Informatika Kota Balikpapan</p>
                    <p class="flex items-start gap-2">
                        <span class="material-symbols-outlined text-base text-outline shrink-0">place</span>
                        Jl. Jend Sudirman RT. 13 No. 1 Balikpapan
                    </p>
                    <p class="flex items-center gap-2">
                        <span class="material-symbols-outlined text-base text-outline shrink-0">call</span>
                        (0542) 7737584
                    </p>
                </div>
                <a href="https://maps.google.com/?q=Diskominfo+Balikpapan" target="_blank"
                   class="inline-flex items-center gap-2 self-start bg-primary text-on-primary text-xs font-extrabold px-4 py-2 rounded-full hover:opacity-90 transition-opacity">
    ...
    <div class="mt-8 rounded-xl border border-outline-variant bg-surface-container px-5 py-4 flex items-start gap-3">
        ...
        <p class="text-xs text-outline leading-relaxed">
            Layanan informasi publik tersedia pada hari kerja, Senin–Jumat pukul 08.00–16.00 WITA.
            Untuk permohonan melalui formulir online atau email, kami akan merespons sesuai ketentuan yang berlaku.
        </p>
    </div>
