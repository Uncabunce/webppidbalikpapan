...
<main class="bg-surface min-h-screen">
    <section class="relative py-20 overflow-hidden border-b border-outline-variant/10">
        ...
        <div class="max-w-4xl mx-auto px-6 relative z-10 text-center">
            <nav class="flex justify-center mb-4 text-xs font-medium text-white/60 uppercase tracking-widest gap-2">
                ...
                <span>Profil</span>
                <span>/</span>
                <span class="text-white">Profil Singkat</span>
            </nav>
    ...
    <!-- ================================ -->
    <div class="max-w-4xl mx-auto px-4 md:px-6 py-12 space-y-10">
        ...
        <div class="bg-white rounded-2xl border border-outline-variant/30 shadow-sm overflow-hidden">
            <div class="bg-primary px-6 py-4 flex items-center gap-3">
                <span class="material-symbols-outlined text-secondary-container">apartment</span>
                <h2 class="text-white font-headline font-extrabold text-base">Tentang PPID Kota Balikpapan</h2>
            </div>
            <div class="px-6 py-6">
                <p class="text-sm text-on-surface leading-relaxed">
                    Pemerintah Kota Balikpapan berkomitmen untuk memberikan layanan kepada masyarakat guna memenuhi kebutuhan informasi publik. Dalam rangka pelaksanaan <strong>Undang-Undang Nomor 14 Tahun 2008</strong> tentang KIP dan <strong>Peraturan Pemerintah Nomor 61 Tahun 2010</strong>, maka sejak tahun 2011 Pemerintah Kota Balikpapan telah menerbitkan <strong>Surat Keputusan Nomor 188.45-171/2011</strong> tanggal 12 Mei 2011 tentang Penunjukkan dan Pengangkatan Pejabat Pengelola Informasi dan Dokumentasi (PPID) Kota Balikpapan.
                </p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-outline-variant/30 shadow-sm overflow-hidden">
            <div class="bg-primary px-6 py-4 flex items-center gap-3">
                <span class="material-symbols-outlined text-secondary-container">account_tree</span>
                <h2 class="text-white font-headline font-extrabold text-base">Struktur Organisasi PPID</h2>
            </div>
            <div class="px-6 py-6">
                <p class="text-sm text-on-surface leading-relaxed mb-6">
                    Struktur organisasi PPID di Pemerintah Kota Balikpapan terdiri dari unsur-unsur berikut:
                </p>
                <div class="space-y-3">

                    <div class="flex items-start gap-4 p-4 rounded-xl bg-surface-container-low border border-outline-variant/20">
                        <div class="shrink-0 w-9 h-9 rounded-full bg-primary flex items-center justify-center">
                            <span class="material-symbols-outlined text-white text-base">stars</span>
                        </div>
                        <div>
                            <p class="text-xs font-extrabold text-outline uppercase tracking-widest mb-0.5">Pengarah</p>
                            <p class="text-sm font-bold text-on-surface">Sekretaris Daerah</p>
                        </div>
                    </div>

                    <div class="flex items-start gap-4 p-4 rounded-xl bg-surface-container-low border border-outline-variant/20">
                        <div class="shrink-0 w-9 h-9 rounded-full bg-primary flex items-center justify-center">
                            <span class="material-symbols-outlined text-secondary-container text-base">manage_accounts</span>
                        </div>
                        <div>
                            <p class="text-xs font-extrabold text-outline uppercase tracking-widest mb-0.5">Ketua PPID Utama</p>
                            <p class="text-sm font-bold text-on-surface">Kepala Dinas Komunikasi dan Informatika</p>
                        </div>
                    </div>

                    <div class="flex items-start gap-4 p-4 rounded-xl bg-surface-container-low border border-outline-variant/20">
                        <div class="shrink-0 w-9 h-9 rounded-full bg-surface-container-high flex items-center justify-center">
                            <span class="material-symbols-outlined text-primary text-base">edit_note</span>
                        </div>
                        <div>
                            <p class="text-xs font-extrabold text-outline uppercase tracking-widest mb-0.5">Sekretaris</p>
                            <p class="text-sm font-bold text-on-surface">Sekretaris Dinas Komunikasi dan Informatika Kota Balikpapan</p>
                        </div>
                    </div>

                    <p class="text-xs font-extrabold text-outline uppercase tracking-widest px-1 pt-2">Anggota & Bidang</p>

                    <?php
                    $members = [
                        ["groups", "Tim Pertimbangan", "Kepala Perangkat Daerah se-Kota Balikpapan"],
                        ["analytics", "Pengelolaan Informasi", "Kepala Bidang Pengendalian, Pembiayaan, dan Pelaporan Bappeda Litbang Kota Balikpapan"],
                        ["inventory_2", "Dokumentasi dan Arsip", "Kepala Bidang Kearsipan Dinas Perpustakaan dan Arsip Kota Balikpapan"],
                        ["wifi_calling_3", "Pelayanan Informasi", "Kepala Bidang Informasi dan Komunikasi Dinas Komunikasi dan Informatika Kota Balikpapan"],
                        ["gavel", "Pengaduan & Penyelesaian Sengketa", "Kepala Bagian Hukum Setda Kota Balikpapan"],
                        ["support_agent", "PPID Pembantu", "Pejabat Pengelola Informasi dan Dokumentasi Pembantu se-Kota Balikpapan"],
                        ["badge", "Pejabat Fungsional", "Pranata Humas, Pranata Komputer, dan Arsiparis"],
                    ];
                    foreach ($members as $m) { ?>
                    <div class="flex items-start gap-4 p-4 rounded-xl bg-surface-container-low border border-outline-variant/20">
                        <div class="shrink-0 w-9 h-9 rounded-full bg-surface-container-high flex items-center justify-center">
                            <span class="material-symbols-outlined text-primary text-base"><?= $m[0] ?></span>
                        </div>
                        <div>
                            <p class="text-xs font-extrabold text-outline uppercase tracking-widest mb-0.5"><?= $m[1] ?></p>
                            <p class="text-sm font-medium text-on-surface"><?= $m[2] ?></p>
                        </div>
                    </div>
                    <?php } ?>
                </div>
        ...
        <div class="bg-white rounded-2xl border border-outline-variant/30 shadow-sm overflow-hidden">
            <div class="bg-primary px-6 py-4 flex items-center gap-3">
                <span class="material-symbols-outlined text-secondary-container">task</span>
                <h2 class="text-white font-headline font-extrabold text-base">Tugas Pelaksanaan</h2>
            </div>
            <div class="px-6 py-6">
                <p class="text-sm text-on-surface leading-relaxed">
                    Tugas pelaksanaan pengelolaan dan pelayanan informasi publik di lingkungan Pemerintah Kota Balikpapan dilakukan oleh:
                </p>
                <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="flex items-center gap-3 p-4 rounded-xl border-2 border-primary/20 bg-primary/5">
                        <span class="material-symbols-outlined text-primary text-2xl shrink-0">shield_person</span>
                        <p class="text-sm font-bold text-primary leading-snug">PPID Utama</p>
                    </div>
                    <div class="flex items-center gap-3 p-4 rounded-xl border-2 border-primary/20 bg-primary/5">
                        <span class="material-symbols-outlined text-primary text-2xl shrink-0">groups</span>
                        <p class="text-sm font-bold text-primary leading-snug">PPID Pembantu di Lingkungan Pemkot Balikpapan</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-outline-variant/30 shadow-sm overflow-hidden">
            <div class="bg-primary px-6 py-4 flex items-center gap-3">
                <span class="material-symbols-outlined text-secondary-container">menu_book</span>
                <h2 class="text-white font-headline font-extrabold text-base">Dasar Hukum</h2>
            </div>
            <div class="px-6 py-6">
                <p class="text-sm text-on-surface leading-relaxed mb-6">
                    Dalam melaksanakan kegiatan pengelolaan dan pelayanan informasi, Pemerintah Kota Balikpapan mengacu pada peraturan perundang-undangan berikut:
                </p>
                <ul class="space-y-3">
                    <?php
                    $regs = [
                        ...
                        ["Keputusan Wali Kota Balikpapan Nomor 188.45-122/2019", "tanggal 5 Maret 2019 tentang Pejabat Pengelola Layanan Informasi dan Dokumentasi Pemerintah Kota Balikpapan"],
                    ];
                    foreach ($regs as $i => $r) { ?>
                    <li class="flex items-start gap-4 p-4 rounded-xl border border-outline-variant/20 hover:bg-surface-container-low transition-colors">
                        <span class="shrink-0 w-7 h-7 rounded-full bg-secondary-container text-on-secondary-container font-headline font-extrabold text-xs flex items-center justify-center mt-0.5"><?= $i + 1 ?></span>
                        <div>
                            <p class="text-sm font-bold text-primary"><?= $r[0] ?></p>
                            <p class="text-xs text-outline mt-0.5"><?= $r[1] ?></p>
                        </div>
                    </li>
                    <?php } ?>
                </ul>
