...
<main class="bg-surface min-h-screen">
    <section class="relative py-20 overflow-hidden border-b border-outline-variant/10">
        ...
        <div class="max-w-4xl mx-auto px-6 relative z-10 text-center">
            <nav class="flex justify-center mb-4 text-xs font-medium text-white/60 uppercase tracking-widest gap-2">
                ...
                <span>Profil</span>
                <span>/</span>
                <span class="text-white">Waktu Pelayanan</span>
            </nav>
    ...
    <p class="text-center text-sm text-outline mb-10">
        Penyelenggaraan Pelayanan Informasi Publik di Pemerintah Kota Balikpapan
        dilaksanakan pada <strong class="font-semibold text-on-surface">hari kerja Senin — Jumat</strong>
    ...
    <div class="space-y-4">
        ...
        <div class="rounded-2xl border border-primary-container bg-surface-container-lowest shadow-sm overflow-hidden">
            <div class="bg-primary px-6 py-3 flex items-center gap-3">
                <span class="material-symbols-outlined text-secondary-container text-xl">calendar_today</span>
                <h2 class="font-headline font-extrabold text-white text-sm tracking-wide">Senin — Kamis</h2>
            </div>
            <div class="px-6 py-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div class="flex items-center gap-4">
                    <div class="text-center">
                        <p class="text-[10px] font-extrabold uppercase tracking-widest text-outline mb-1">Mulai</p>
                        <p class="font-headline font-extrabold text-2xl text-primary">09.00</p>
                        <p class="text-[10px] text-outline">WITA</p>
                    </div>
                    <span class="material-symbols-outlined text-outline-variant text-2xl">arrow_forward</span>
                    <div class="text-center">
                        <p class="text-[10px] font-extrabold uppercase tracking-widest text-outline mb-1">Selesai</p>
                        <p class="font-headline font-extrabold text-2xl text-primary">15.00</p>
                        <p class="text-[10px] text-outline">WITA</p>
                    </div>
                </div>
                <div class="flex items-center gap-2 bg-surface-container rounded-xl px-4 py-3">
                    <span class="material-symbols-outlined text-secondary text-base">no_meals</span>
                    <div>
                        <p class="text-[10px] font-extrabold uppercase tracking-widest text-outline">Istirahat</p>
                        <p class="text-xs font-semibold text-on-surface">12.00 — 13.00 WITA</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="rounded-2xl border border-tertiary-container bg-surface-container-lowest shadow-sm overflow-hidden">
            <div class="bg-tertiary-container px-6 py-3 flex items-center gap-3">
                <span class="material-symbols-outlined text-on-tertiary-container text-xl">calendar_today</span>
                <h2 class="font-headline font-extrabold text-on-tertiary-container text-sm tracking-wide">Jumat</h2>
            </div>
            <div class="px-6 py-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div class="flex items-center gap-4">
                    <div class="text-center">
                        <p class="text-[10px] font-extrabold uppercase tracking-widest text-outline mb-1">Mulai</p>
                        <p class="font-headline font-extrabold text-2xl text-tertiary">09.00</p>
                        <p class="text-[10px] text-outline">WITA</p>
                    </div>
                    <span class="material-symbols-outlined text-outline-variant text-2xl">arrow_forward</span>
                    <div class="text-center">
                        <p class="text-[10px] font-extrabold uppercase tracking-widest text-outline mb-1">Selesai</p>
                        <p class="font-headline font-extrabold text-2xl text-tertiary">11.00</p>
                        <p class="text-[10px] text-outline">WITA</p>
                    </div>
                </div>
                <div class="flex items-center gap-2 bg-surface-container rounded-xl px-4 py-3">
                    <span class="material-symbols-outlined text-outline text-base">info</span>
                    <p class="text-xs text-outline leading-snug">Layanan lebih singkat<br>pada hari Jumat</p>
                </div>
            </div>
        </div>

        {{-- Sabtu & Minggu --}}
        <div class="rounded-2xl border border-outline-variant bg-surface-container px-6 py-4 flex items-center gap-3">
            <span class="material-symbols-outlined text-outline text-xl shrink-0">event_busy</span>
            <p class="text-xs text-outline leading-relaxed">
                <strong class="font-semibold text-on-surface">Sabtu & Minggu</strong> — Layanan informasi publik tidak tersedia pada hari libur dan hari besar nasional.
            </p>
        </div>
    ...
    {{-- Note --}}
    <div class="mt-8 rounded-xl border border-secondary-container bg-secondary-container/10 px-5 py-4 flex items-start gap-3">
        <span class="material-symbols-outlined text-secondary text-lg shrink-0 mt-0.5">schedule</span>
        <p class="text-xs text-on-surface leading-relaxed">
            Waktu pelayanan dapat berubah pada hari-hari tertentu sesuai kebijakan Pemerintah Kota Balikpapan.
            Untuk informasi lebih lanjut, hubungi kami melalui <strong class="font-semibold">ppid@balikpapan.go.id</strong>
            atau telepon <strong class="font-semibold">(0542) 421420</strong>.
        </p>
    </div>
