...
<main class="bg-surface min-h-screen">
    <section class="relative py-20 overflow-hidden border-b border-outline-variant/10">
        ...
        <div class="max-w-4xl mx-auto px-6 relative z-10 text-center">
            <nav class="flex justify-center mb-4 text-xs font-medium text-white/60 uppercase tracking-widest gap-2">
                ...
                <span>Profil</span>
                <span>/</span>
                <span class="text-white">Tugas-dan-Fungsi-PPID</span>
            </nav>
    ...
    {{-- Two-column layout: Tugas + Kewenangan --}}
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="rounded-2xl border border-primary-container bg-surface-container-lowest shadow-sm overflow-hidden">
            <div class="bg-primary px-6 py-4 flex items-center gap-3">
                <span class="material-symbols-outlined text-secondary-container text-2xl">task_alt</span>
                <h2 class="font-headline font-extrabold text-white text-lg tracking-wide">Tugas</h2>
            </div>
            <ul class="divide-y divide-outline-variant/30">
                @foreach([
                    ...
                    'Menugaskan PPID Pelaksana dan/atau Pejabat Fungsional untuk mengumpulkan, mengelola, dan memelihara informasi dan dokumentasi',
                ] as $i => $tugas)
                <li class="flex items-start gap-3 px-5 py-3 hover:bg-surface-container transition-colors">
                    <span class="mt-0.5 w-5 h-5 rounded-full bg-secondary-container text-on-secondary-container text-[10px] font-extrabold flex items-center justify-center shrink-0">
                        {{ $i + 1 }}
                    </span>
                    <span class="text-xs text-on-surface leading-relaxed">{{ $tugas }}</span>
                </li>
                @endforeach
            </ul>
        </div>
        ...
        <div class="rounded-2xl border border-tertiary-container bg-surface-container-lowest shadow-sm overflow-hidden">
            <div class="bg-tertiary-container px-6 py-4 flex items-center gap-3">
                <span class="material-symbols-outlined text-on-tertiary-container text-2xl">gavel</span>
                <h2 class="font-headline font-extrabold text-on-tertiary-container text-lg tracking-wide">Kewenangan</h2>
            </div>
            <ul class="divide-y divide-outline-variant/30">
                @foreach([
                    ...
                    'Mengoordinasikan pemberian pelayanan informasi dan dokumentasi dengan PPID Pelaksana yang menjadi cakupan kerjanya',
                ...
                <li class="flex items-start gap-3 px-5 py-3 hover:bg-surface-container transition-colors">
                    <span class="mt-0.5 w-5 h-5 rounded-full bg-tertiary text-on-tertiary text-[10px] font-extrabold flex items-center justify-center shrink-0">
                        {{ $i + 1 }}
                    </span>
                    <span class="text-xs text-on-surface leading-relaxed">{{ $wewenang }}</span>
                </li>
                @endforeach
            </ul>
        </div>
    ...
    <p class="mt-8 text-center text-xs text-outline">
        Berdasarkan ketentuan peraturan perundang-undangan yang berlaku tentang Keterbukaan Informasi Publik.
    </p>
