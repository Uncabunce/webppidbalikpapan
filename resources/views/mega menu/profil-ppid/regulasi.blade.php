...
<main class="bg-surface min-h-screen">
    <section class="relative py-20 overflow-hidden border-b border-outline-variant/10">
        ...
        <div class="max-w-4xl mx-auto px-6 relative z-10 text-center">
            <nav class="flex justify-center mb-4 text-xs font-medium text-white/60 uppercase tracking-widest gap-2">
                ...
                <span>Profil</span>
                <span>/</span>
                <span class="text-white">Regulasi Dasar Hukum</span>
            </nav>
    ...
    <p class="text-center text-sm text-outline mb-10">
        Dasar hukum pelaksanaan PPID Pemerintah Kota Balikpapan mengacu pada peraturan perundang-undangan berikut:
    </p>
    ...
    <div class="space-y-6">
        ...
        {{-- UU --}}
        <div class="rounded-2xl border border-primary-container bg-surface-container-lowest shadow-sm overflow-hidden">
            <div class="bg-primary px-6 py-3 flex items-center gap-3">
                <span class="material-symbols-outlined text-secondary-container text-xl">gavel</span>
                <h2 class="font-headline font-extrabold text-white text-sm tracking-wide">Undang-Undang</h2>
            </div>
            <ul class="divide-y divide-outline-variant/30">
                @foreach([
                    ['no' => 'UU No. 14 Tahun 2008', 'title' => 'Keterbukaan Informasi Publik'],
                    ['no' => 'UU No. 25 Tahun 2009', 'title' => 'Pelayanan Publik'],
                    ['no' => 'UU No. 23 Tahun 2014', 'title' => 'Pemerintahan Daerah'],
                ] as $reg)
                <li class="flex items-start gap-3 px-5 py-3">
                    <div>
                        <p class="text-xs font-extrabold text-primary">{{ $reg['no'] }}</p>
                        <p class="text-xs text-on-surface leading-snug">tentang {{ $reg['title'] }}</p>
                    </div>
                </li>
                @endforeach
            </ul>
        ...
        <div class="rounded-2xl border border-primary-container bg-surface-container-lowest shadow-sm overflow-hidden">
            <div class="bg-primary-container px-6 py-3 flex items-center gap-3">
                <span class="material-symbols-outlined text-on-primary-container text-xl">account_balance</span>
                <h2 class="font-headline font-extrabold text-on-primary-container text-sm tracking-wide">Peraturan Pemerintah</h2>
            </div>
            <ul class="divide-y divide-outline-variant/30">
                @foreach([
                    ['no' => 'PP No. 61 Tahun 2010', 'title' => 'Pelaksanaan Undang-Undang Nomor 14 Tahun 2008 tentang Keterbukaan Informasi Publik'],
                    ['no' => 'PP No. 96 Tahun 2012', 'title' => 'Pelaksanaan Undang-Undang Nomor 25 Tahun 2009 tentang Pelayanan Publik'],
                ] as $reg)
                <li class="flex items-start gap-3 px-5 py-3">
                    <div>
                        <p class="text-xs font-extrabold text-primary">{{ $reg['no'] }}</p>
        ...
        <div class="rounded-2xl border border-tertiary-container bg-surface-container-lowest shadow-sm overflow-hidden">
            <div class="bg-tertiary-container px-6 py-3 flex items-center gap-3">
                <span class="material-symbols-outlined text-on-tertiary-container text-xl">policy</span>
                <h2 class="font-headline font-extrabold text-on-tertiary-container text-sm tracking-wide">Peraturan Komisi Informasi</h2>
            </div>
            <ul class="divide-y divide-outline-variant/30">
                @foreach([
                    ['no' => 'Perki No. 1 Tahun 2010', 'title' => 'Standar Layanan Informasi Publik'],
                    ['no' => 'Perki No. 1 Tahun 2013', 'title' => 'Prosedur Penyelesaian Sengketa Informasi Publik'],
                    ['no' => 'Perki No. 1 Tahun 2021', 'title' => 'Standar Layanan Informasi Publik (Revisi)'],
                ] as $reg)
                <li class="flex items-start gap-3 px-5 py-3">
                    <div>
                        <p class="text-xs font-extrabold text-tertiary">{{ $reg['no'] }}</p>
                        <p class="text-xs text-on-surface leading-snug">tentang {{ $reg['title'] }}</p>
                    </div>
                </li>
                @endforeach
        ...
        {{-- Keputusan Wali Kota --}}
        <div class="rounded-2xl border border-secondary-container bg-surface-container-lowest shadow-sm overflow-hidden">
            <div class="bg-secondary-container px-6 py-3 flex items-center gap-3">
                <span class="material-symbols-outlined text-on-secondary-container text-xl">assured_workload</span>
                <h2 class="font-headline font-extrabold text-on-secondary-container text-sm tracking-wide">Keputusan Wali Kota Balikpapan</h2>
            </div>
            <ul class="divide-y divide-outline-variant/30">
                @foreach([
                    ['no' => 'Perwali No. 19 Tahun 2020', 'title' => 'Pedoman Pengelolaan Pelayanan Informasi dan Dokumentasi di Lingkungan Pemerintah Kota Balikpapan'],
                    ['no' => 'SK Wali Kota', 'title' => 'Penetapan Pejabat Pengelola Informasi dan Dokumentasi (PPID) Utama dan Pelaksana Pemerintah Kota Balikpapan'],
                ] as $reg)
                <li class="flex items-start gap-3 px-5 py-3">
                    <div>
                        <p class="text-xs font-extrabold text-secondary">{{ $reg['no'] }}</p>
                        <p class="text-xs text-on-surface leading-snug">tentang {{ $reg['title'] }}</p>
                    </div>
                </li>
                @endforeach
    ...
    {{-- Note --}}
    <div class="mt-8 rounded-xl border border-outline-variant bg-surface-container px-5 py-4 flex items-start gap-3">
        <span class="material-symbols-outlined text-outline text-lg shrink-0 mt-0.5">info</span>
        <p class="text-xs text-outline leading-relaxed">
            Daftar regulasi di atas merupakan dasar hukum utama. Peraturan perundang-undangan lain yang relevan
            juga berlaku sepanjang tidak bertentangan dengan ketentuan yang lebih tinggi.
        </p>
    </div>
