...
<main class="bg-surface min-h-screen">
    ...
    <div class="max-w-5xl mx-auto px-4 md:px-6 py-12 space-y-6">
        ...
        <div class="bg-white rounded-2xl border border-outline-variant/30 shadow-sm overflow-hidden">
            <div class="flex items-center justify-between px-6 py-4 border-b border-outline-variant/20">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="font-headline font-extrabold text-on-surface text-sm">SOP Pengembangan Infrastruktur PPID Kota Balikpapan</p>
                        <p class="text-xs text-outline mt-0.5">Format: PDF &nbsp;&middot;&nbsp; SOP PPID</p>
                    </div>
                </div>
                <span class="text-[10px] font-extrabold uppercase tracking-widest text-primary bg-primary/10 px-3 py-1 rounded-full hidden sm:inline-block">SOP</span>
            </div>
            <div class="px-6 py-4 flex flex-wrap gap-3">
                <a href="{{ asset('images/sop_ppid/8.pdf') }}" target="_blank"
                ...
                <a href="{{ asset('images/sop_ppid/8.pdf') }}" download
            ...
            <div class="px-6 pb-6">
                <div class="bg-surface-container rounded-xl overflow-hidden border border-outline-variant/20">
                    <object
                        data="{{ asset('images/sop_ppid/8.pdf') }}"
