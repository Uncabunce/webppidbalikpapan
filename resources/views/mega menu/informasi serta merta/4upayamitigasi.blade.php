    ...
    <section class="relative py-20 overflow-hidden border-b border-outline-variant/10">
        ...
        <div class="max-w-4xl mx-auto px-6 relative z-10 text-center">
            <nav class="flex justify-center mb-4 text-xs font-medium text-white/60 uppercase tracking-widest gap-2">
                ...
                <span>/</span>
                <span class="text-white">4 Upaya Mitigasi</span>
            </nav>
            <h1 class="text-4xl md:text-5xl font-headline font-extrabold text-white leading-tight mb-4">
                Informasi Tentang<br>4 Upaya Mitigasi
            </h1>
            <p class="text-white/70 text-lg max-w-2xl mx-auto">
                Informasi Serta Merta 4 Upaya Mitigasi Terhadap Bencana Kebakaran Hutan dan Lahan di Kota Balikpapan
            </p>
        </div>
    </section>
    ...
    <div class="max-w-5xl mx-auto px-4 md:px-6 py-12 space-y-10">
        ...
        <div class="bg-white rounded-2xl border border-outline-variant/30 shadow-sm overflow-hidden">
            <div class="bg-primary px-6 py-4 flex items-center gap-3">
                ...
                <div>
                    <p class="text-white font-headline font-extrabold text-sm leading-tight">Informasi 4 Upaya Mitigasi &mdash; Pemerintah Kota Balikpapan</p>
        ...
        <!-- Dokumen Card -->
        <div>
            <h2 class="text-lg font-headline font-extrabold text-primary mb-5">Dokumen 4 Upaya Mitigasi Bencana</h2>
            <div class="bg-white rounded-2xl border border-outline-variant/30 shadow-sm overflow-hidden">
                <div class="flex items-center justify-between px-6 py-4 border-b border-outline-variant/20">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="font-headline font-extrabold text-on-surface text-sm">Informasi Tentang 4 Upaya Mitigasi Bencana &mdash; Pemerintah Kota Balikpapan</p>
                ...
                <div class="px-6 py-4 flex flex-wrap gap-3">
                    <a href="{{ asset('infosertamerta/mitigasi.pdf') }}" target="_blank"
                    ...
                    <a href="{{ asset('infosertamerta/mitigasi.pdf') }}" download
                ...
                <div class="px-6 pb-6">
                    <div class="bg-surface-container rounded-xl overflow-hidden border border-outline-variant/20">
                        <object
                            data="{{ asset('infosertamerta/mitigasi.pdf') }}"
        ...
        <div class="bg-surface-container-low rounded-2xl border border-outline-variant/20 px-6 py-5 flex gap-4 items-start">
            ...
            <div>
                ...
                <p class="text-xs text-outline leading-relaxed">Informasi Tentang Upaya Mitigasi Bencana merupakan informasi serta merta yang wajib diumumkan segera oleh Pemerintah Kota Balikpapan karena berkaitan langsung dengan keselamatan dan ketertiban umum masyarakat. Dokumen ini berisi panduan dan informasi kesiapsiagaan menghadapi bencana di Kota Balikpapan sesuai dengan ketentuan Undang-Undang No. 14 Tahun 2008 tentang Keterbukaan Informasi Publik.</p>
            </div>
        </div>
