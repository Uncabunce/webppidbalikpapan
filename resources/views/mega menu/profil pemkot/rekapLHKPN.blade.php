    ...
    <section class="relative py-20 overflow-hidden border-b border-outline-variant/10">
        ...
        <div class="max-w-4xl mx-auto px-6 relative z-10 text-center">
            <nav class="flex justify-center mb-4 text-xs font-medium text-white/60 uppercase tracking-widest gap-2">
                ...
                <span>Profil</span>
                <span>/</span>
                <span class="text-white">Rekap LHKPN</span>
            </nav>
    ...
    <div class="max-w-5xl mx-auto px-4 md:px-6 py-12 space-y-10">
        ...
        <div class="bg-white rounded-2xl border border-outline-variant/30 shadow-sm overflow-hidden">
            <div class="bg-primary px-6 py-4 flex items-center gap-3">
                ...
                <div>
                    <p class="text-white font-headline font-extrabold text-sm leading-tight">Rekapitulasi Penyampaian LHKAN — Tahun 2023</p>
                    <p class="text-white/60 text-xs mt-0.5">Nomor: 700/0169/Itkot &nbsp;·&nbsp; Balikpapan, 27 Maret 2024</p>
                </div>
            </div>
            <div class="px-6 py-4 flex flex-wrap gap-6 text-sm text-on-surface">
                <div class="flex items-center gap-2">
                    ...
                    <span>Inspektorat Kota Balikpapan</span>
                </div>
                <div class="flex items-center gap-2">
                    <span class="material-symbols-outlined text-base text-outline">person</span>
                    <span>Silvia Rahmadina, AP., CGCAE., CGRE., QIA</span>
                </div>
                <div class="flex items-center gap-2">
                    <span class="material-symbols-outlined text-base text-outline">send</span>
                    <span>Kepada: Menteri PANRB, Jakarta</span>
                </div>
            </div>
        </div>
        ...
        <!-- Stat Cards -->
        <div>
            <h2 class="text-lg font-headline font-extrabold text-primary mb-5">Ringkasan Data</h2>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="bg-white rounded-2xl border border-outline-variant/30 shadow-sm p-6">
                    ...
                    <p class="text-3xl font-headline font-extrabold text-primary">4.133</p>
                    <p class="text-xs text-outline mt-1 leading-snug">Jumlah Seluruh Aparatur Negara</p>
                    <div class="mt-4 pt-4 border-t border-outline-variant/30 flex gap-4 text-xs text-on-surface">
                        <div>
                            <span class="font-bold text-primary">620</span>
                            <span class="text-outline ml-1">Wajib LHKPN</span>
                        </div>
                        <div>
                            <span class="font-bold text-primary">3.513</span>
                            <span class="text-outline ml-1">Tidak Wajib</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl border border-outline-variant/30 shadow-sm p-6">
                    <div class="flex items-start justify-between mb-3">
                        ...
                        <span class="text-[10px] font-extrabold uppercase tracking-widest text-green-700 bg-green-50 px-2 py-1 rounded-full">100%</span>
                    </div>
                    <p class="text-3xl font-headline font-extrabold text-green-700">620</p>
                    <p class="text-xs text-outline mt-1 leading-snug">Wajib LHKPN yang <strong>telah</strong> melaporkan harta kekayaan</p>
                    <div class="mt-4 pt-4 border-t border-outline-variant/30">
                        <div class="w-full bg-green-100 rounded-full h-1.5">
                            <div class="bg-green-500 h-1.5 rounded-full" style="width:100%"></div>
                        </div>
                        <p class="text-[10px] text-green-700 mt-1 font-semibold">620 dari 620 terpenuhi</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl border border-outline-variant/30 shadow-sm p-6">
                    <div class="flex items-start justify-between mb-3">
                        <span class="material-symbols-outlined text-2xl text-outline">unpublished</span>
                        <span class="text-[10px] font-extrabold uppercase tracking-widest text-outline bg-surface-container px-2 py-1 rounded-full">0%</span>
                    </div>
                    <p class="text-3xl font-headline font-extrabold text-on-surface">0</p>
                    <p class="text-xs text-outline mt-1 leading-snug">Wajib LHKPN yang <strong>belum</strong> melaporkan harta kekayaan</p>
                    <div class="mt-4 pt-4 border-t border-outline-variant/30">
                        <div class="w-full bg-surface-container rounded-full h-1.5">
                            <div class="bg-outline h-1.5 rounded-full" style="width:0%"></div>
                        </div>
                        <p class="text-[10px] text-outline mt-1">Tidak ada yang tertunggak</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl border border-outline-variant/30 shadow-sm p-6">
                    <div class="flex items-start justify-between mb-3">
                        <span class="material-symbols-outlined text-2xl text-secondary-container" style="color:#b08800;">receipt_long</span>
                        <span class="text-[10px] font-extrabold uppercase tracking-widest text-amber-700 bg-amber-50 px-2 py-1 rounded-full">100%</span>
                    </div>
                    <p class="text-3xl font-headline font-extrabold" style="color:#785900;">3.513</p>
                    <p class="text-xs text-outline mt-1 leading-snug">Tidak wajib LHKPN yang <strong>telah</strong> menyampaikan via SPT Tahunan</p>
                    <div class="mt-4 pt-4 border-t border-outline-variant/30">
                        <div class="w-full bg-amber-100 rounded-full h-1.5">
                            <div class="h-1.5 rounded-full" style="width:100%;background:#b08800;"></div>
                        </div>
                        <p class="text-[10px] mt-1 font-semibold" style="color:#785900;">3.513 dari 3.513 terpenuhi</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl border border-outline-variant/30 shadow-sm p-6">
                    ...
                    <p class="text-3xl font-headline font-extrabold text-on-surface">0</p>
                    <p class="text-xs text-outline mt-1 leading-snug">Tidak wajib LHKPN yang <strong>belum</strong> menyampaikan via SPT Tahunan</p>
                    <div class="mt-4 pt-4 border-t border-outline-variant/30">
                        <p class="text-[10px] text-outline">Semua telah menyampaikan</p>
                    </div>
                </div>
                ...
                <div class="bg-primary rounded-2xl shadow-sm p-6">
                    <div class="flex items-start justify-between mb-3">
                        <span class="material-symbols-outlined text-2xl text-secondary-container">verified</span>
                        <span class="text-[10px] font-extrabold uppercase tracking-widest text-white/70 bg-white/10 px-2 py-1 rounded-full">Tunggakan</span>
                    </div>
                    <p class="text-3xl font-headline font-extrabold text-white">0</p>
                    <p class="text-xs text-white/70 mt-1 leading-snug">Total aparatur yang belum menyampaikan kewajiban LHKAN</p>
                    <div class="mt-4 pt-4 border-t border-white/20">
                        <p class="text-[10px] text-secondary-container font-bold">✓ Seluruh kewajiban telah terpenuhi</p>
                    </div>
                </div>
